...
module kim_model_driver_initialization_module
  ...
  public &
    ...
    kim_model_driver_initialization_get_number_of_parameter_files, &
    kim_model_driver_initialization_get_parameter_file_name, &
    kim_model_driver_initialization_set_model_numbering, &
    kim_model_driver_initialization_set_influence_distance, &
    kim_model_driver_initialization_set_cutoffs, &
    kim_model_driver_initialization_set_reinit, &
    kim_model_driver_initialization_set_destroy, &
    kim_model_driver_initialization_set_compute_func, &
    kim_model_driver_initialization_set_species_code, &
    kim_model_driver_initialization_set_argument_attribute, &
    kim_model_driver_initialization_set_call_back_attribute, &
    kim_model_driver_initialization_set_parameter, &
    kim_model_driver_initialization_set_model_buffer, &
    kim_model_driver_initialization_set_units, &
    kim_model_driver_initialization_convert_unit, &
    kim_model_driver_initialization_log, &
    kim_model_driver_initialization_string

  type, bind(c) :: kim_model_driver_initialization_type
    private
    type(c_ptr) :: p
  end type kim_model_driver_initialization_type

  interface kim_model_driver_initialization_set_parameter
    subroutine kim_model_driver_initialization_set_parameter_int( &
      model_driver_initialization, int1, description, ierr)
      use, intrinsic :: iso_c_binding
      import kim_model_driver_initialization_type
      implicit none
  ...
  end interface kim_model_driver_initialization_set_parameter
  ...
  interface
    ...
    subroutine kim_model_driver_initialization_log( &
      model_driver_initialization, log_verbosity, message, line_number, &
      file_name)
      use, intrinsic :: iso_c_binding
    ...
    subroutine kim_model_driver_initialization_string( &
      model_driver_initialization, string)
      use, intrinsic :: iso_c_binding
      import kim_model_driver_initialization_type
      implicit none
      type(kim_model_driver_initialization_type), intent(in) &
...
end module kim_model_driver_initialization_module
