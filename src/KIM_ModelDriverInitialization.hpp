...
#define KIM_MODEL_DRIVER_INITIALIZATION_HPP_
...
{
 public:
  void get_number_of_parameter_files(int * const numberOfParameterFiles) const;
 ...
 private:
  ...
  ModelDriverInitialization(ModelDriverInitialization const &);
  void operator=(ModelDriverInitialization const &);

  ModelDriverInitialization();
  ~ModelDriverInitialization();

  class ModelDriverInitializationImplementation;
  ModelDriverInitializationImplementation * pimpl;
};  // class ModelDriverInitialization
}  // namespace KIM
#endif  // KIM_MODEL_DRIVER_INITIALIZATION_HPP_
