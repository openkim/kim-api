...
#define LOG_SILENT(message)                                             \
  modelReinitialization->Log(KIM_LOG_VERBOSITY_silent, message,         \
                             __LINE__, __FILE__)
#else
#define LOG_SILENT(message)
#endif
...
#define LOG_FATAL(message)                                              \
  modelReinitialization->Log(KIM_LOG_VERBOSITY_fatal, message,          \
                             __LINE__, __FILE__)
#else
#define LOG_FATAL(message)
#endif
...
#define LOG_ERROR(message)                                              \
  modelReinitialization->Log(KIM_LOG_VERBOSITY_error, message,          \
                             __LINE__, __FILE__)
#else
#define LOG_ERROR(message)
#endif
...
#define LOG_WARNING(message)                                            \
  modelReinitialization->Log(KIM_LOG_VERBOSITY_warning, message,        \
                             __LINE__, __FILE__)
#else
#define LOG_WARNING(message)
#endif
...
#define LOG_INFORMATION(message)                                        \
  modelReinitialization->Log(KIM_LOG_VERBOSITY_information, message,    \
                             __LINE__, __FILE__)
#else
#define LOG_INFORMATION(message)
#endif
...
#define LOG_DEBUG(message)                                              \
  modelReinitialization->Log(KIM_LOG_VERBOSITY_debug, message,          \
                             __LINE__, __FILE__)
#else
#define LOG_DEBUG(message)
#endif
