...
module kim_unit_system_f_module
  implicit none
  private
...
end module kim_unit_system_f_module

! free functions to implement kim_unit_system_module

subroutine kim_length_unit_string(length_unit, unit_string)
  use, intrinsic :: iso_c_binding
  use kim_unit_system_module, only : kim_length_unit_type
  use kim_unit_system_f_module, only : length_unit_string
  implicit none
  type(kim_length_unit_type), intent(in), value :: length_unit
...
subroutine kim_energy_unit_string(energy_unit, unit_string)
  use, intrinsic :: iso_c_binding
  use kim_unit_system_module, only : kim_energy_unit_type
  use kim_unit_system_f_module, only : energy_unit_string
  implicit none
  type(kim_energy_unit_type), intent(in), value :: energy_unit
  character(len=*), intent(out) :: unit_string
...
subroutine kim_charge_unit_string(charge_unit, unit_string)
  use, intrinsic :: iso_c_binding
  use kim_unit_system_module, only : kim_charge_unit_type
  use kim_unit_system_f_module, only : charge_unit_string
  implicit none
  type(kim_charge_unit_type), intent(in), value :: charge_unit
  character(len=*), intent(out) :: unit_string
...
subroutine kim_temperature_unit_string(temperature_unit, unit_string)
  use, intrinsic :: iso_c_binding
  use kim_unit_system_module, only : kim_temperature_unit_type
  use kim_unit_system_f_module, only : temperature_unit_string
  implicit none
  type(kim_temperature_unit_type), intent(in), value :: temperature_unit
  character(len=*), intent(out) :: unit_string
...
subroutine kim_time_unit_string(time_unit, unit_string)
  use, intrinsic :: iso_c_binding
  use kim_unit_system_module, only : kim_time_unit_type
  use kim_unit_system_f_module, only : time_unit_string
  implicit none
  type(kim_time_unit_type), intent(in), value :: time_unit
  character(len=*), intent(out) :: unit_string
