...
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_coordinates = {3};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_get_neigh = {4};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_process_dEdr = {5};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_process_d2Edr2 = {6};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_neighObject = {7};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_compute = {8};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_reinit = {9};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_destroy = {10};
KIM_COMPUTE_ArgumentName const KIM_COMPUTE_ARGUMENT_NAME_cutoff = {11};
