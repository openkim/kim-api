...
module kim_model_initialization_f_module
  implicit none
  private
  ...
  public &
    ...
    convert_unit, &
    log, &
    model_initialization_string

  interface
    integer(c_int) function set_model_numbering(model_initialization, &
      numbering) bind(c, name="KIM_ModelInitialization_set_model_numbering")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
    ...
    subroutine set_influence_distance(model_initialization, &
      influence_distance) &
      bind(c, name="KIM_ModelInitialization_set_influence_distance")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
      type(kim_model_initialization_type), intent(inout) :: model_initialization
    ...
    subroutine set_cutoffs(model_initialization, number_of_cutoffs, &
      cutoffs_ptr) bind(c, name="KIM_ModelInitialization_set_cutoffs")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
      type(kim_model_initialization_type), intent(inout) :: model_initialization
    ...
    integer(c_int) function set_reinit(model_initialization, language_name, &
      fptr) bind(c, name="KIM_ModelInitialization_set_reinit")
      use, intrinsic :: iso_c_binding
    ...
    integer(c_int) function set_destroy(model_initialization, language_name, &
      fptr) bind(c, name="KIM_ModelInitialization_set_destroy")
      use, intrinsic :: iso_c_binding
      use kim_language_name_module, only : kim_language_name_type
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
    ...
    integer(c_int) function set_compute_func(model_initialization, &
      language_name, fptr) &
      bind(c, name="KIM_ModelInitialization_set_compute_func")
      use, intrinsic :: iso_c_binding
      use kim_language_name_module, only : kim_language_name_type
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
    ...
    integer(c_int) function set_species_code(model_initialization, &
      species_name, code) &
      bind(c, name="KIM_ModelInitialization_set_species_code")
      use, intrinsic :: iso_c_binding
    ...
    integer(c_int) function set_argument_attribute(model_initialization, &
      argument_name, attribute) &
      bind(c, name="KIM_ModelInitialization_set_argument_attribute")
      use, intrinsic :: iso_c_binding
    ...
    integer(c_int) function set_call_back_attribute(model_initialization, &
      call_back_name, attribute) &
      bind(c, name="KIM_ModelInitialization_set_call_back_attribute")
      use, intrinsic :: iso_c_binding
    ...
    integer(c_int) function set_parameter_int(model_initialization, &
      extent, ptr, description) &
      bind(c, name="KIM_ModelInitialization_set_parameter_int")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
      type(kim_model_initialization_type), intent(inout) :: model_initialization
    ...
    integer(c_int) function set_parameter_double(model_initialization, &
      extent, ptr, description) &
      bind(c, name="KIM_ModelInitialization_set_parameter_double")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
      type(kim_model_initialization_type), intent(inout) :: model_initialization
    ...
    subroutine set_model_buffer(model_initialization, ptr) &
      bind(c, name="KIM_ModelInitialization_set_model_buffer")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
      type(kim_model_initialization_type), intent(inout) :: model_initialization
    ...
    integer(c_int) function set_units(model_initialization, length_unit, &
      energy_unit, charge_unit, temperature_unit, time_unit) &
      bind(c, name="KIM_ModelInitialization_set_units")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
    ...
    subroutine log(model_initialization, log_verbosity, message, line_number, &
      file_name) bind(c, name="KIM_ModelInitialization_Log")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
    ...
    type(c_ptr) function model_initialization_string(model_initialization) &
      bind(c, name="KIM_ModelInitialization_string")
      use, intrinsic :: iso_c_binding
      use kim_model_initialization_module, only : kim_model_initialization_type
      implicit none
      type(kim_model_initialization_type), intent(in) :: model_initialization
    end function model_initialization_string
  end interface
end module kim_model_initialization_f_module


! free functions to implement kim_model_initialization_module
...
subroutine kim_model_initialization_set_model_numbering( &
  ...
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_numbering_module, only : kim_numbering_type
  use kim_model_initialization_f_module, only : set_model_numbering
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_numbering_type), intent(in), value :: numbering
  integer(c_int), intent(out) :: ierr

  ierr = set_model_numbering(model_initialization, numbering)
...
subroutine kim_model_initialization_set_influence_distance( &
  ...
  use, intrinsic :: iso_c_binding
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_influence_distance
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  real(c_double), intent(in), target :: influence_distance

  call set_influence_distance(model_initialization, c_loc(influence_distance))
...
subroutine kim_model_initialization_set_cutoffs(model_initialization, &
  ...
  use, intrinsic :: iso_c_binding
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_cutoffs
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  integer(c_int), intent(in), value :: number_of_cutoffs
  real(c_double), intent(in), target :: cutoffs(number_of_cutoffs)

  call set_cutoffs(model_initialization, number_of_cutoffs, c_loc(cutoffs))
...
subroutine kim_model_initialization_set_reinit(model_initialization, &
  ...
  use kim_language_name_module, only : kim_language_name_type
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_reinit
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_language_name_type), intent(in), value :: language_name
  type(c_funptr), intent(in), value :: fptr
  ...
  ierr = set_reinit(model_initialization, language_name, fptr)
...
subroutine kim_model_initialization_set_destroy(model_initialization, &
  ...
  use kim_language_name_module, only : kim_language_name_type
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_destroy
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_language_name_type), intent(in), value :: language_name
  type(c_funptr), intent(in), value :: fptr
  ...
  ierr = set_destroy(model_initialization, language_name, fptr)
...
subroutine kim_model_initialization_set_compute_func(model_initialization, &
  ...
  use kim_language_name_module, only : kim_language_name_type
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_compute_func
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_language_name_type), intent(in), value :: language_name
  type(c_funptr), intent(in), value :: fptr
  ...
  ierr = set_compute_func(model_initialization, language_name, fptr)
...
subroutine kim_model_initialization_set_species_code(model_initialization, &
  ...
  use kim_species_name_module, only : kim_species_name_type
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_species_code
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_species_name_type), intent(in), value :: species_name
  integer(c_int), intent(in), value :: code
  ...
  ierr = set_species_code(model_initialization, species_name, code)
...
subroutine kim_model_initialization_set_argument_attribute( &
  ...
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_attribute_module, only : kim_attribute_type
  use kim_model_initialization_f_module, only : set_argument_attribute
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_argument_name_type), intent(in), value :: argument_name
  type(kim_attribute_type), intent(in), value :: attribute
  ...
  ierr = set_argument_attribute(model_initialization, argument_name, attribute)
...
subroutine kim_model_initialization_set_call_back_attribute( &
  ...
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_attribute_module, only : kim_attribute_type
  use kim_model_initialization_f_module, only : set_call_back_attribute
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(kim_call_back_name_type), intent(in), value :: call_back_name
  type(kim_attribute_type), intent(in), value :: attribute
  ...
  ierr = set_call_back_attribute(model_initialization, call_back_name, &
    attribute)
end subroutine kim_model_initialization_set_call_back_attribute

subroutine kim_model_initialization_set_parameter_int(model_initialization, &
  int1, description, ierr)
  use, intrinsic :: iso_c_binding
  use kim_model_initialization_module, only : kim_model_initialization_type
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  ...
  call set_parameter(model_initialization, size(int1, 1, c_int), int1, &
    description, ierr)
  return

contains
  subroutine set_parameter(model_initialization, extent, int1, &
    description, ierr)
    use, intrinsic :: iso_c_binding
    use kim_model_initialization_module, only : kim_model_initialization_type
    use kim_model_initialization_f_module, only : set_parameter_int
    implicit none
    type(kim_model_initialization_type), intent(inout) :: model_initialization
    integer(c_int), intent(in), value :: extent
    ...
    ierr = set_parameter_int(model_initialization, extent, c_loc(int1), &
      trim(description)//c_null_char)
  end subroutine set_parameter
end subroutine kim_model_initialization_set_parameter_int

subroutine kim_model_initialization_set_parameter_double(model_initialization, &
  ...
  call set_parameter(model_initialization, size(double1, 1, c_int), double1, &
    description, ierr)
  return

contains
  subroutine set_parameter(model_initialization, extent, double1, &
    description, ierr)
    use, intrinsic :: iso_c_binding
    use kim_model_initialization_module, only : kim_model_initialization_type
    use kim_model_initialization_f_module, only : set_parameter_int
    ...
    ierr = set_parameter_int(model_initialization, extent, c_loc(double1), &
      trim(description)//c_null_char)
  end subroutine set_parameter
end subroutine kim_model_initialization_set_parameter_double

subroutine kim_model_initialization_set_model_buffer(model_initialization, ptr)
  use, intrinsic :: iso_c_binding
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : set_model_buffer
  implicit none
  type(kim_model_initialization_type), intent(inout) :: model_initialization
  type(c_ptr), intent(in), value :: ptr

  call set_model_buffer(model_initialization, ptr)
...
subroutine kim_model_initialization_set_units(model_initialization, &
  ...
  use kim_unit_system_module, only : &
    ...
    kim_temperature_unit_type, &
    kim_time_unit_type
  use kim_model_initialization_f_module, only : set_units
  implicit none
  type(kim_model_initialization_type), intent(in) :: model_initialization
  type(kim_length_unit_type), intent(in), value :: length_unit
  type(kim_energy_unit_type), intent(in), value :: energy_unit
  ...
  ierr = set_units(model_initialization, length_unit, energy_unit, &
...
subroutine kim_model_initialization_convert_unit( &
  ...
  use kim_unit_system_module, only : kim_temperature_unit_type
  use kim_unit_system_module, only : kim_time_unit_type
  use kim_model_initialization_f_module, only : convert_unit
  implicit none
  type(kim_model_initialization_type), intent(in) :: model_initialization
  type(kim_length_unit_type), intent(in), value :: from_length_unit
  type(kim_energy_unit_type), intent(in), value :: from_energy_unit
  ...
  ierr = convert_unit(model_initialization, from_length_unit, &
...
subroutine kim_model_initialization_log(model_initialization, log_verbosity, &
  message, line_number, file_name)
  use, intrinsic :: iso_c_binding
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_log_verbosity_module, only : kim_log_verbosity_type
  use kim_model_initialization_f_module, only : log
  implicit none
  type(kim_model_initialization_type), intent(in) :: model_initialization
  type(kim_log_verbosity_type), intent(in), value :: log_verbosity
  ...
  call log(model_initialization, log_verbosity, trim(message)//c_null_char, &
...
subroutine kim_model_initialization_string(model_initialization, string)
  use, intrinsic :: iso_c_binding
  use kim_model_initialization_module, only : kim_model_initialization_type
  use kim_model_initialization_f_module, only : model_initialization_string
  implicit none
  type(kim_model_initialization_type), intent(in) :: model_initialization
  ...
  p = model_initialization_string(model_initialization)
