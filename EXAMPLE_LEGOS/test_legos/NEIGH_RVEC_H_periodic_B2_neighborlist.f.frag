!-------------------------------------------------------------------------------
!
! NEIGH_RVEC_H_periodic_B2_neighborlist
!
!-------------------------------------------------------------------------------
subroutine NEIGH_RVEC_H_periodic_B2_neighborlist(CellsPerHalfSide, cutoff,  &
...
end subroutine NEIGH_RVEC_H_periodic_B2_neighborlist
