!-------------------------------------------------------------------------------
!
! NEIGH_RVEC_H_periodic_FCC_neighborlist
!
!-------------------------------------------------------------------------------
subroutine NEIGH_RVEC_H_periodic_FCC_neighborlist(CellsPerHalfSide, cutoff, FCCspacing, N, NN, neighborList, RijList)
  use KIM_API
  implicit none
  ...
  if (N.ne.1) then ! check assumption that N==1
     print *,"* ERROR: NEIGH_RVEC_H_periodic_FCC_neighborlist called with N.ne.1"
     stop
  endif
...
end subroutine NEIGH_RVEC_H_periodic_FCC_neighborlist
