...
module model_demo_P_LJ_NEIGH_PURE_F_F
	use  KIMservice
	implicit none
...
end module model_demo_P_LJ_NEIGH_PURE_F_F

!  Model Initiation routine (it calls actual initialization routine in the module model_demo_P_LJ_NEIGH_PURE_F)
subroutine model_demo_p_lj_neigh_pure_f_f_init(pkim)
	use model_demo_P_LJ_NEIGH_PURE_F_F
	implicit none
	integer(kind=kim_intptr) :: kim; pointer(pkim,kim)
	call lj_init(pkim)
end subroutine model_demo_p_lj_neigh_pure_f_f_init
