...
#define KIM_STATUS_INCONSISTENT_BASE_UNIT          -24
#define KIM_STATUS_UNSUPPORTED_UNIT_TIME           -23
#define KIM_STATUS_UNSUPPORTED_UNIT_TEMPERATURE    -22
#define KIM_STATUS_UNSUPPORTED_UNIT_CHARGE         -21
#define KIM_STATUS_UNSUPPORTED_UNIT_ENERGY         -20
#define KIM_STATUS_UNSUPPORTED_UNIT_LENGTH         -19
#define KIM_STATUS_WRONG_UNIT_HANDLING             -18

#define KIM_STATUS_WRONG_GROUP_ARGUMENT_KEY        -17
#define KIM_STATUS_NUMARGS_NOT_DIVISIBLE_BY_4      -16
