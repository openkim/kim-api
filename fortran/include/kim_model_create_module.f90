...
module kim_model_create_module
  ...
  implicit none
  private &
    kim_model_create_handle_equal, &
    kim_model_create_handle_not_equal
...
contains
  ...
  subroutine kim_set_destroy_pointer(model_create_handle, &
  ...
  subroutine kim_set_compute_pointer(model_create_handle, &
    language_name, fptr, ierr)
    use, intrinsic :: iso_c_binding
    use kim_language_name_module, only : kim_language_name_type
    implicit none
  ...
  subroutine kim_set_species_code(model_create_handle, &
  ...
  subroutine kim_set_units(model_create_handle, &
