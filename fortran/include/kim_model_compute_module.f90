...
module kim_model_compute_module
  ...
  public &
    ...
    kim_model_compute_process_dedr_term, &
    kim_model_compute_process_d2edr2_term, &
  ...
  interface kim_model_compute_get_argument_pointer
    subroutine kim_model_compute_get_argument_pointer_int0( &
      model_compute_handle, argument_name, int0, ierr)
      use, intrinsic :: iso_c_binding
    ...
    subroutine kim_model_compute_get_argument_pointer_int1( &
      model_compute_handle, argument_name, extent1, int1, ierr)
      use, intrinsic :: iso_c_binding
      use kim_argument_name_module, only : kim_argument_name_type
      import kim_model_compute_handle_type
      implicit none
    ...
    subroutine kim_model_compute_get_argument_pointer_int2( &
      model_compute_handle, argument_name, extent1, extent2, int2, ierr)
      use, intrinsic :: iso_c_binding
      use kim_argument_name_module, only : kim_argument_name_type
      import kim_model_compute_handle_type
      implicit none
  ...
  end interface kim_model_compute_get_argument_pointer
  ...
  interface
    ...
    subroutine kim_model_compute_get_model_buffer_pointer( &
