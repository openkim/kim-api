...
module kim_compute_arguments_module
  ...
  implicit none
  private &
    kim_compute_arguments_handle_equal, &
    kim_compute_arguments_handle_not_equal
  ...
  interface kim_set_argument_pointer
    module procedure kim_set_argument_pointer_int0
    module procedure kim_set_argument_pointer_int1
    module procedure kim_set_argument_pointer_int2
    module procedure kim_set_argument_pointer_double0
    module procedure kim_set_argument_pointer_double1
    module procedure kim_set_argument_pointer_double2
...
contains
  ...
  subroutine kim_get_argument_support_status( &
    ...
    ierr = get_argument_support_status(compute_arguments, &
      compute_argument_name, support_status)
  end subroutine kim_get_argument_support_status

  subroutine kim_get_callback_support_status( &
    ...
    ierr = get_callback_support_status(compute_arguments, &
      compute_callback_name, support_status)
  end subroutine kim_get_callback_support_status

  subroutine kim_set_argument_pointer_int0( &
  ...
  end subroutine kim_set_argument_pointer_int0

  subroutine kim_set_argument_pointer_int1( &
  ...
  end subroutine kim_set_argument_pointer_int1

  subroutine kim_set_argument_pointer_int2( &
  ...
  end subroutine kim_set_argument_pointer_int2

  subroutine kim_set_argument_pointer_double0( &
  ...
  end subroutine kim_set_argument_pointer_double0

  subroutine kim_set_argument_pointer_double1( &
  ...
  end subroutine kim_set_argument_pointer_double1

  subroutine kim_set_argument_pointer_double2( &
  ...
  end subroutine kim_set_argument_pointer_double2

  subroutine kim_set_callback_pointer( &
  ...
  end subroutine kim_set_callback_pointer

  subroutine kim_are_all_required_present( &
    ...
    interface
      ...
      ierr = are_all_required_arguments_and_callbacks_present(compute_arguments, &
        result_value)
    end subroutine kim_are_all_required_present
