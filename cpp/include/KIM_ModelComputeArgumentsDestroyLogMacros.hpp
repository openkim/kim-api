...
#define LOG_FATAL(message)                                              \
  modelComputeArgumentsDestroy->LogEntry(KIM::LOG_VERBOSITY::fatal, message, \
                                         __LINE__, __FILE__)
#else
#define LOG_FATAL(message)
#endif
...
#define LOG_ERROR(message)                                              \
  modelComputeArgumentsDestroy->LogEntry(KIM::LOG_VERBOSITY::error, message, \
                                         __LINE__, __FILE__)
#else
#define LOG_ERROR(message)
#endif
...
#define LOG_WARNING(message)                                            \
  modelComputeArgumentsDestroy->LogEntry(KIM::LOG_VERBOSITY::warning, message, \
                                         __LINE__, __FILE__)
#else
#define LOG_WARNING(message)
#endif
...
#define LOG_INFORMATION(message)                                        \
  modelComputeArgumentsDestroy->LogEntry(KIM::LOG_VERBOSITY::information, \
...
#define LOG_DEBUG(message)                                              \
  modelComputeArgumentsDestroy->LogEntry(KIM::LOG_VERBOSITY::debug, message, \
                                         __LINE__, __FILE__)
#else
#define LOG_DEBUG(message)
#endif
