!*******************************************************************************
!**
!**  MODULE model_Ar_LJ_NEIGH_RVEC_F_f90
!**
...
end module model_Ar_LJ_NEIGH_RVEC_F_f90
...
!
!-------------------------------------------------------------------------------
subroutine model_Ar_LJ_NEIGH_RVEC_F_f90_init(pkim)
  use model_Ar_LJ_NEIGH_RVEC_F_f90
  use KIMservice
  implicit none
  ...
  if (kim_api_set_data_f(pkim,"reinit",sz,loc(ReInit)).ne.1) &
...
end subroutine model_Ar_LJ_NEIGH_RVEC_F_f90_init
