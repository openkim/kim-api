!*******************************************************************************
!**
!**  MODULE model_Ar_LJ_CLUSTER_f90
!**
...
end module model_Ar_LJ_CLUSTER_f90
...
!
!-------------------------------------------------------------------------------
subroutine model_Ar_LJ_CLUSTER_f90_init(pkim)
  use model_Ar_LJ_CLUSTER_f90
  use KIMservice
  implicit none
...
end subroutine model_Ar_LJ_CLUSTER_f90_init
