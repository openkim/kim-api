...
if(TARGET kim-api)
    ...
    set(KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE "") # invalid in build directory
    ...
    find_program(KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE kim-api-v2-collections-info
      PATH_SUFFIXES libexec/kim-api-v2 PATHS ${KIM-API-INTERNAL_PREFIX})
    execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} system models        OUTPUT_VARIABLE KIM_API_MODEL_IDENTIFIER        OUTPUT_STRIP_TRAILING_WHITESPACE)
    string(REGEX REPLACE "^.*/([^/]+)" "\\1" KIM_API_MODEL_IDENTIFIER "${KIM_API_MODEL_IDENTIFIER}")
    execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} system model_drivers OUTPUT_VARIABLE KIM_API_MODEL_DRIVER_IDENTIFIER OUTPUT_STRIP_TRAILING_WHITESPACE)
    ...
    find_package_handle_standard_args(KIM-API-V2
        REQUIRED_VARS KIM-API-V2_INCLUDE_DIRS KIM-API-V2_LIBRARIES KIM-API-V2_CMAKE_DIR KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE
        VERSION_VAR KIM-API-V2_VERSION)
    mark_as_advanced(KIM-API-V2_INCLUDE_DIRS KIM-API-V2_LIBRARIES KIM-API-V2_CMAKE_DIR KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE)
endif()
...
if(TARGET kim-api)
    ...
    if(KIM-API-V2_INSTALL_TYPE STREQUAL "SYSTEM")
        execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} system models        OUTPUT_VARIABLE KIM-API-V2_MODEL_INSTALL_PREFIX OUTPUT_STRIP_TRAILING_WHITESPACE)
        execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} system model_drivers OUTPUT_VARIABLE KIM-API-V2_MODEL_DRIVER_INSTALL_PREFIX OUTPUT_STRIP_TRAILING_WHITESPACE)
    elseif(KIM-API-V2_INSTALL_TYPE STREQUAL "USER")
        execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} config_file models        OUTPUT_VARIABLE KIM-API-V2_MODEL_INSTALL_PREFIX OUTPUT_STRIP_TRAILING_WHITESPACE)
        execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} config_file model_drivers OUTPUT_VARIABLE KIM-API-V2_MODEL_DRIVER_INSTALL_PREFIX OUTPUT_STRIP_TRAILING_WHITESPACE)
    elseif(KIM-API-V2_INSTALL_TYPE STREQUAL "ENVIRONMENT")
        execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} env models        OUTPUT_VARIABLE KIM-API-V2_MODEL_INSTALL_PREFIX OUTPUT_STRIP_TRAILING_WHITESPACE)
        execute_process(COMMAND ${KIM-API-V2_COLLECTIONS_INFO_EXECUTABLE} env model_drivers OUTPUT_VARIABLE KIM-API-V2_MODEL_DRIVER_INSTALL_PREFIX OUTPUT_STRIP_TRAILING_WHITESPACE)
        # TODO error if empty
