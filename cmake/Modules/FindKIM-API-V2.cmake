...
if(TARGET kim-api)
    set(KIM-API-V2_MODEL_INSTALL_PREFIX ${CMAKE_INSTALL_FULL_LIBDIR}/${PROJECT_NAME}/models)
    set(KIM-API-V2_MODEL_DRIVER_INSTALL_PREFIX ${CMAKE_INSTALL_FULL_LIBDIR}/${PROJECT_NAME}/model_drivers)
else()
