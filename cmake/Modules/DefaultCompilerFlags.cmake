...
enable_cxx_compiler_flag_if_supported("-flto=2")
if(KIM_API_ENABLE_COVERAGE)
...
enable_c_compiler_flag_if_supported("-flto=2")
if(KIM_API_ENABLE_COVERAGE)
...
if(NOT CMAKE_Fortran_COMPILER_ID STREQUAL Intel)
  ...
  enable_fortran_compiler_flag_if_supported("-flto=2")
else()
  ...
  # should add options for lto at some point
endif()
if(KIM_API_ENABLE_COVERAGE)
