...
if(GIT_FOUND)
  if(EXISTS "${CMAKE_SOURCE_DIR}/.git")
    ...
    set(KIM_API_BUILD_METADATA
      "${KIM_API_GIT_COMMIT_ID}.${CMAKE_CXX_COMPILER_ID}"
      )
    ...
    set(KIM_API_BUILD_METADATA "${CMAKE_CXX_COMPILER_ID}")
  endif()
endif()
#
set(PROJECT_VERSION_BUILD_METADATA "${KIM_API_BUILD_METADATA}" CACHE STRING "TODO ..." FORCE)
