...
if(NOT DEFINED BASH_COMPLETION_COMPLETIONSDIR)
  ...
  if(NOT
    ...
    set(BASH_COMPLETION_COMPLETIONSDIR "${CMAKE_INSTALL_SYSCONFDIR}/bash_completion.d")
  endif()
else()
...
if(NOT DEFINED ZSH_COMPLETION_COMPLETIONSDIR)
  set(ZSH_COMPLETION_COMPLETIONSDIR "${CMAKE_INSTALL_SYSCONFDIR}/zsh_completion.d")
else()
