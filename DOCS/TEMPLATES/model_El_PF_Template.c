...
/*******************************************************************************
*
*  model_<FILL element name>_PF_<FILL model name>
*
...
#define MODEL_CUTOFF <FILL model cutoff value> /* cutoff radius in angstroms */
...
{
   /* local variables */
   <FILL place any local variable declarations here>;
