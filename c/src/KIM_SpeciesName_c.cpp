...
KIM_SpeciesName const KIM_SPECIES_NAME_Uut = {ID_Nh};  // Nihonium
KIM_SpeciesName const KIM_SPECIES_NAME_Fl = {ID_Fl};  // Flerovium
KIM_SpeciesName const KIM_SPECIES_NAME_Uup = {ID_Mc};  // Moscovium
KIM_SpeciesName const KIM_SPECIES_NAME_Lv = {ID_Lv};  // Livermorium
KIM_SpeciesName const KIM_SPECIES_NAME_Uus = {ID_Ts};  // Tennessine
KIM_SpeciesName const KIM_SPECIES_NAME_Uuo = {ID_Og};  // Oganesson
